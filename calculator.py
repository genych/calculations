...
def choose():
        ...
        if choice.upper() == "MPG":
            traveled = float_input("How many miles were traveled?")
            fuel = float_input("How many gallons of fuel were used?")
            ...
            weight = float_input("How much does the object weight (in kilograms)?")
            speed = float_input("What is the speed of the object (in meters per second)?")
            ...
            hours_worked = float_input("How many hours were worked?")
            pay_rate = float_input("What is the pay rate per hour?")
            ...
            foot = float_input("How many feet would would you like to convert?")
            meter = feet_to_meters(foot)
            print(str(foot) + " feet is " + str(meter) + " meters.")
            choose()

        elif choice.upper() == "YIELD":
            sales = float_input("How much is money was brought in(sales)?")
            hours = float_input("How many labor hours were used?")
            ...
            sales = float_input("How much money was brought in(sales)?")
            payroll = float_input("How much money was spent on labor?")
            ...
            sales = float_input("How much money was brought in(sales)?")
            payroll = float_input("How much money was spent on labor?")
            cost_of_sales = float_input("How much did the merchandise cost?")
